...
\geometry{left=1.4cm, top=1.4cm, right=1.4cm, bottom=1.2cm, footskip=.5cm}
...
%-------------------------------------------------------------------------------
\name{Yuvraj Singh Bawa}{}
\position{Undergraduate student at NITK Surathkal}
%\address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+91) 7795571411} 
%%% Social
\email{rajayuv@gmail.com}
\homepage{www.yuvrajsingh.me}
\github{maligndrome}
\linkedin{yuvrajsinghbawa}
